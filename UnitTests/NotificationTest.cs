    ...
    public class NotificationTest
    {
        ...
        public void CreateTest() {
            var n = new Notification()
            {
                ...
                EventId = 998,
                Recepients = new List<NotificationRecepient>() { new NotificationRecepient() { UserId = "00264bbb-d0c7-488a-8f09-c31b626fab56" }, new NotificationRecepient() { UserId = "003373e1-f6ae-4687-a043-2535c4686b08" } },
                NotificationAttachments = new List<NotificationAttachment>() { new NotificationAttachment() { Name = "some.pdf", AttachmentDataStr = "adasdsadasda" } }
            };
            try
            {
