...
class SearchInput extends Component {
  ...
  componentDidUpdate() {
    ...
    if (this.props.dynamicWidth) {
      ...
      if (this.props.multiSelect === true) {
        ...
        maxInputWidth = wrapperRight - inputLeft;
      }
  ...
  setValue() {
    if (this.props.multiSelect === false) {
      // SINGLE value
      if (
        this.props.dropDownValue !== null &&
        this.props.dropDownValue !== ""
      ) {
        // There is DropDown Value
        if (this.state.inputOnFocus === true) {
          // Input ON FOCUS
  ...
  onInputKeyDown(e) {
    if (e.keyCode === 32 && !this.props.multiSelect) {
      /* SPACE */ e.stopPropagation();
    } else {
    ...
    return (
      ...
      >
        ...
        {this.props.dynamicWidth && !this.props.multiSelect && (
          <input
            ref={(el) => {
              ...
              if (this.props.setFakeValueRef) {
                this.props.setFakeValueRef(el);
              }
            }}
        ...
        <input
          ...
          className={
            "search-input" +
            (this.props.dynamicWidth ? "" : " pl25") +
            (this.props.value.length > 0 ? " pr25" : "")
          }
          style={style}
