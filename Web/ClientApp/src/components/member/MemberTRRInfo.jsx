    ...
    return (
      <div>
        <CheckBox
          className="mb-05"
          onClick={() =>
            this.props.updateMemberProperty(
              "releaseSigned",
              !this.props.member.releaseSigned,
            )
          }
        ...
        <CheckBox
          ...
          onClick={() =>
            this.props.updateMemberProperty(
              "liabilitySigned",
              !this.props.member.liabilitySigned,
            )
          }
        ...
        <CheckBox
          ...
          onClick={() =>
            this.props.updateMemberProperty(
              "trrBackgroundCheck",
              !this.props.member.trrBackgroundCheck,
            )
          }
        ...
        <CheckBox
          ...
          onClick={() =>
            this.props.updateMemberProperty(
              ...
              !this.props.member.codeOfConductTraining,
            )
          }
        ...
        <CheckBox
          ...
          onClick={() =>
            this.props.updateMemberProperty(
              ...
              !this.props.member.otherBackgroundCheck,
            )
          }
        ...
        <ul className="input-fields first-child-text-125 mt-3">
          <li>
            ...
            <DatePicker
              ...
              onSelect={(value) => {
                this.props.updateMemberProperty("joinDate", value);
              }}
            />
          </li>
          {/*<li>
          ...
          <li>
            ...
            <MultiDropDown
              ...
              onDropDownValueChange={(value) =>
                this.props.updateMemberProperty("status", value)
              }
            />
          </li>
          <li>
            ...
            <MultiDropDown
              ...
              onDropDownValueChange={(value) => {
                console.log(value);
                this.props.updateMemberProperty("roles", [value]);
              }}
            />
          </li>
          <li>
            ...
            <MultiDropDown
              ...
              list={[
                { name: "Civilian", id: 54 },
                { name: "Veteran", id: 53 },
                { name: "Veteran Family/Caregiver", id: 55 },
              ]}
              multiSelect={false}
              keyProperty="id"
              textProperty="name"
              ...
              onDropDownValueChange={(value) =>
                this.props.updateMemberProperty("userType", value)
              }
            />
          </li>
          <li>
            ...
            <textarea
              ...
              onChange={(e) =>
                this.props.updateMemberProperty("comments", e.target.value)
              }
            />
          </li>
        </ul>
