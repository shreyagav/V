    ...
    render() {
        ...
        return (
            ...
            <div
                ...
                style={this.props.open || !this.props.toggleable ? this.style : {"display":"none"}}
            >
                <SimpleBar>
                    ...
                    {   
                        ...
                        >
                            ...
                            >
                                {this.props.allowMultiple &&
                                    <label>
                                        <input 
                                            ...
                                            onChange={() => { this.checkBoxSelected(index, -1, element); this.setState({ setFocusToIndex: index, setFocusToInnerIndex: -1 }) }} /* */
                                        />
                                        <CheckBoxSVG />
                                    </label>
                                }
                                ...
                                >   {this.props.renderItem ? this.props.renderItem(element, this.props.keyProperty, this.props.textProperty) : <span>{element[this.props.textProperty]}</span> }
                                        ...
                                        >
                                            ...
                                            <label>
                                                <input 
                                                    type="checkbox" 
                                                        checked={el.checked}
                                                        onChange={() => { this.checkBoxSelected(index, innerIndex, el); this.setState({ setFocusToIndex: index, setFocusToInnerIndex: -1 }); }}
                                                />
                                                <CheckBoxSVG />
                                            </label>
                                            <span>{el.name}</span>
