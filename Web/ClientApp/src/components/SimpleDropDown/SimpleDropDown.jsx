...
export class SimpleDropDown extends React.Component {
    ...
    unselect(evt, element){
        this.props.onChange(this.props.selectedValues.filter(a=>a!=element[this.props.keyProperty]));
    }
    ...
    render() {
        ...
        var allowMultiple = typeof(this.props.allowMultiple)!=undefined?this.props.allowMultiple : false;
        var adjustedList = this.props.list;
        if(this.props.allowMultiple === true){
            if(Array.isArray(this.props.selectedValues))
            {
                selectedValues = this.props.list.filter(a=>this.props.selectedValues.includes(a[this.props.keyProperty]));
            }else{
                var found = this.props.list.find(a=>a[this.props.keyProperty] === this.props.selectedValues);
                if(found)
                    selectedValues = [found];
                else
                    selectedValues = [];
            }
            ...
            selectedValues = this.props.list.find(a=>a[this.props.keyProperty] === this.props.selectedValues);
        }
        return (
