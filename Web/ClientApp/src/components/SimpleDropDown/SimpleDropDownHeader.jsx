        ...
        return (
            ...
            >
                <ul 
                    ...
                    className={this.props.allowMultiple ? "multi-level-list" : "simple-list"}
                >
                        {Array.isArray(this.props.selectedValue) && this.props.selectedValue.map(element => 
                            <li key={element[this.props.keyProperty]}>
                                {this.props.renderSelectedItem?this.props.renderSelectedItem(element,this.props.keyProperty,this.props.textProperty):(<span>{element[this.props.textProperty]}</span>)}
                        ...
                        {typeof(this.props.selectedValue)=="object" && !Array.isArray(this.props.selectedValue)&&
                            <li className={this.props.allowMultiple ? 'inverted' : ''}>
                                {this.props.renderSelectedItem?this.props.renderSelectedItem(this.props.selectedValue,this.props.keyProperty,this.props.textProperty):(<span>{this.props.selectedValue[this.props.textProperty]}</span>)}
                            </li>
                        }
                </ul>
