...
class Event extends Component {
  ...
  setDefaultChapter(props) {
    if (
      props.store.userInfo != null &&
      this.state.eventId == 0 &&
      props.store.userInfo.authType == "Secretary"
    ) {
  ...
  componentDidMount() {
    ...
    if (this.state.eventId != 0) {
      Service.getEvent(this.state.eventId)
        .then((data) => {
          component.setState({
            eventMain: component.fixMainEventData(data),
            loading: false,
          });
        })
        .catch((exception) =>
    ...
    let del = () => {
      ...
      this.dialogContent = (
        <div>
          ...
          <p className="m-05">This action can not be undone. Delete anyway?</p>
        </div>
      );
      this.setState({ showDialog: true });
    };
    ...
    if (this.props.match.path == "/new-event") {
      return (
        <h1 className="uppercase-text mb-2">
          New<strong> Event</strong>
        </h1>
      );
    } else {
      return (
        <h1 className="uppercase-text mb-2">
          Edit<strong> Event</strong>
        </h1>
      );
    }
  }
  ...
  performIfValid(callback, callback2) {
    if (this.props.store.isFormValid(this.validators, this.state.eventMain)) {
      callback();
    } else {
      if (callback2) {
        callback2();
      ...
      <div className="pages-wsm-wrapper ipw-800">
        ...
        {this.state.activeTabIndex === 0 && (
          <ul className="input-fields first-child-text-125 mt-1 pl-1 pr-1">
            ...
            <li>
              ...
              <div
                className={
                  this.props.store.checkIfShowError("site", this.validators)
                    ? "error-input-wrapper"
                    : ""
                }
              >
            ...
            >
              ...
              <div
                className={
                  this.props.store.checkIfShowError("date", this.validators)
                    ? "error-input-wrapper"
                    : ""
                }
              >
            ...
            {this.props.newEvent && (
              <React.Fragment>
                ...
                {this.state.eventMain.isRepeatable && (
                  <li
                    className={
                      this.emptyType && this.state.eventMain.isRepeatable
                        ? "mark-invalid"
                        : ""
                    }
                    ...
                    <ul className="input-fields flex-nowrap break-at-560 line-of-inputs-wrapper">
                      <li>
                        <input
                          ...
                          placeholder="#"
                          value={
                            this.state.eventMain.frequency
                              ? this.state.eventMain.frequency
                              : 1
                          }
            ...
            <li>
              ...
              <div className="input-button-wrapper">
                <textarea
                  ...
                  onChange={(evt) =>
                    this.updateEventProperty("description", evt.target.value)
                  }
                />
        ...
        {this.state.activeTabIndex === 2 && (
          <EventBudget
            ...
            onProjectedCostChange={(value) =>
              this.updateEventProperty("projectedCost", value)
            }
          />
        )}
        ...
        {this.state.activeTabIndex === 4 && (
          <EventPictures eventId={this.state.eventId} />
        )}
        <div className="flex-wrap mt-2">
          ...
          {this.state.activeTabIndex < 4 && (
            <button
              ...
              onClick={() =>
                this.performIfValid(this.nextStep, () =>
                  this.setState({ showError: true }),
                )
              }
            >
