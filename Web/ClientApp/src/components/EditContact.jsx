...
class EditContact extends Component {
  ...
  componentDidUpdate() {
    if (
      !this.props.isFormValid(this.props.validators, this.props.value) &&
  ...
  renderName() {
    if (this.props.value.name) {
      ...
      let str2 = "";
      if (this.props.value.phone || this.props.value.email) {
        str2 = ",";
      }
      return (
        <p className="regular-p">
          <strong>{str1 + str2}</strong>
        </p>
      );
    }
  }
  ...
  renderPhone() {
    if (this.props.value.phone) {
      ...
      return (
        <p className="regular-p" style={{ fontSize: "0.9rem" }}>
          {str1 + str2}
        </p>
      );
    }
      ...
      <li>
        ...
        <div className="flex-nowrap flex-flow-column">
          <div
            ...
            style={
              this.state.contactIsOpen
                ? { borderColor: "#0099cc", height: "auto", minHeight: "2.5em" }
                : { height: "auto", minHeight: "2.5em" }
            }
            onClick={() => this.toggle()}
          ...
          {this.state.contactIsOpen && (
            <ul
              className="input-fields first-child-text-60 p-1"
              style={{
                border: "1px solid #0099cc",
                borderTop: "0px solid #0099cc",
              }}
            >
              <li>
                <p>Name:</p>
              ...
              <li>
                ...
                >
                  <input
                    ...
                    placeholder="Phone"
                    onChange={(e) =>
                      this.props.onInputValueChange("phone", e.target.value)
                    }
              ...
              <li>
                ...
                >
                  <input
                    ...
                    placeholder="Email"
                    onChange={(e) =>
                      this.props.onInputValueChange("email", e.target.value)
                    }
                    onKeyDown={(e) => {
                      if (!e.shiftKey && e.keyCode === 9) {
                        this.toggle();
