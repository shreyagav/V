        ...
        if (props.amountOfPages < 8) {
            ...
            if (props.pageNumber < 5) {
                ...
                if (props.pageNumber < props.amountOfPages - 3){
                    ...
                    this.pagination.push(1);
                    this.pagination.push(0);
                    for(let i = props.amountOfPages - 4; i < props.amountOfPages+1; i++){
                        this.pagination.push(i);
                    }
                }
            }
        ...
        return (
            ...
            >
                ...
                <ul className="flex-nowrap pagination">
                    {this.props.pageNumber>1 && 
                        <li>
                            <button onClick={() => this.props.setPageNumber(this.props.pageNumber-1)}>
                                <ArrowUpSVG />
                            </button>
                        </li>
                    }
                        ...
                        <li key={index} className='buttonlike-checkbox'>
                            <label>
                                <input type="radio" name="pagination"
                                    ...
                                    onChange={() => {if (element > 0) {this.props.setPageNumber(element)}}}
                                />
                                {element > 0 ? <span>{element}</span> : <span className='disabled'>{'...'}</span>}
                            </label>
                        </li>
                    )}
