  ...
  render() {
    ...
    const columns = [
      {
        Header: "Name",
        columns: [
          { Header: "First", accessor: "firstName", filterable: true },
          { Header: "Last", accessor: "lastName", filterable: true },
          { Header: "User", accessor: "userName", filterable: true },
        ],
      },
      {
        Header: "Contact",
          ...
          { Header: "Chapter", accessor: "chapter", filterable: true },
          {
            ...
            Cell: (props) => (
              <span className="number">
                {new Date(props.value).toLocaleString("en-US", options)}
              </span>
            ),
          },
        ],
      },
      {
        ...
        columns: [
          ...
          {
            Header: "Email",
            accessor: "emergencyContactEmail",
            filterable: true,
          },
          {
            Header: "Phone",
        ...
        columns: [
          {
            ...
            filterable: true,
            Cell: (props) => (
              <span className="number">{props.value.map((a) => a + ", ")}</span>
            ),
          },
        ],
      },
    ...
    return (
      <div>
        ...
        <h3 className="mr-05 ml-05 mt-2 mb-2 uppercase-text">
          <strong>Members</strong> report
        </h3>
        <ReactTable
