...
const PasswordComponent = (props) => {
  ...
  if (
    typeof props.checkIfShowError === "function" &&
    props.checkIfShowError(props.name, props.validators)
  ) {
  ...
  return (
    <div className={mainDivClassName}>
      ...
      {props.displayValidationErrors &&
        props.displayValidationErrors(props.name, props.validators)}
    </div>
  );
};
