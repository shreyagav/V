...
class SignUp extends Component {
  ...
  constructor(props) {
    ...
    this.checkIfPasswordRepeatValid =
      this.checkIfPasswordRepeatValid.bind(this);
  ...
  checkIfPasswordRepeatValid = (value) => {
    this.props.store.updateValidators(
      "PasswordRepeat",
      this.checkIfMatches(value, this.state.signUpInfo.Password),
      this.validators,
    );
    let tmp = this.state.signUpInfo;
    this.setState({ signUpInfo: tmp });
  ...
  onPasswordRepeatChange = (e) => {
    ...
    if (this.validators["PasswordRepeat"].activated) {
      this.props.store.updateValidators(
        "PasswordRepeat",
        this.checkIfMatches(e.target.value, this.state.signUpInfo.Password),
        this.validators,
      );
    }
    this.handleTextChange(e);
      ...
      <div className="abs-wrapper">
        <div>
          <div className="flex-nowrap align-center justify-space-between mt-2 mb-1">
            <h1 className="uppercase-text mb-05">
          ...
          <ul className="input-fields input-fields-narrow no-uppercase">
              ...
              >
                <div className="input-button-wrapper">
                  <input
                    ...
                    onBlur={() => {
                      this.checkIfFieldValid("Password");
                    }}
                  />
                  {this.state.signUpInfo.Password.length > 0 && (
                    <button
                      onClick={() => {
                        this.inputTypeToggler(this.passwordInputRef);
                      }}
                    >
                      <PasswordShowUpSVG />
              ...
              >
                <div className="input-button-wrapper">
                  <input
                    ...
                    onBlur={() =>
                      this.checkIfPasswordRepeatValid(
                        this.state.signUpInfo.PasswordRepeat,
                      )
                    }
                  />
                  {this.state.signUpInfo.PasswordRepeat.length > 0 && (
                    <button
                      onClick={() => {
                        this.inputTypeToggler(this.passwordRepeatInputRef);
                      }}
                    >
                      <PasswordShowUpSVG />
                      <PasswordHideUpSVG svgClassName={"display-none"} />
            ...
            <li>
              ...
              <div
                className={
                  "mb-1" +
                  (this.props.store.checkIfShowError("Phone", this.validators)
                    ? " error-input-wrapper"
                    : "")
                }
              >
            ...
            <li>
              ...
              <div
                className={
                  "mb-1" +
                  (this.props.store.checkIfShowError("Zip", this.validators)
                    ? " error-input-wrapper"
                    : "")
                }
              >
