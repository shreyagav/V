...
const signUpValidators = () => createValidators([
    ...
    {'name':'PasswordRepeat', 'typeFunction':'compareValues', 'text':'Repeated Password does not match the Password'},
...
const resetPasswordValidators1 = () => createValidators([
    {'name':'Email', 'typeFunction':'email', 'text':'Email'},
]);

const resetPasswordValidators2 = () => createValidators([
    {'name':'Email', 'typeFunction':'email', 'text':'Email'},
    {'name':'NewPassword', 'typeFunction':'password', 'text':'Password'},
    {'name':'NewPasswordRepeat', 'typeFunction':'compareValues', 'text':'Repeated Password does not match the Password'},
]);
  
export { signUpValidators, signInValidators, resetPasswordValidators1, resetPasswordValidators2 };