...
class Status extends Component {
  ...
  returnIcon = (status) => {
    switch (status) {
      case "published":
        return <StatusPublishedSVG />;
      case "canceled":
        return <StatusCanceledSVG />;
      case "draft":
        return <StatusDraftSVG />;
      case "deleted":
        return <StatusDeletedSVG />;
      default:
        return <div></div>;
    }
  };
      ...
      <div
        className={
          this.props.className
            ? this.props.className + " " + this.props.eventStatus + " status"
            : this.props.eventStatus + " status"
        }
      >
        {status}
