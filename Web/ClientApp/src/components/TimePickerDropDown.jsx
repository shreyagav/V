...
export class TimePickerDropDown extends Component {
  ...
  handleClick(e) {
    if (!this.props.timeNumberPickerRef.contains(e.target)) {
      this.props.toggle();
    }
  }
    ...
    if (this.props.properties.timePickerMode) {
      return (
        <div
          ...
          style={
            this.checkIfOpensBottom(this.props.dropDownWrapperRef)
              ? this.styleBottom
              : this.styleTop
          }
        >
          ...
          <div>
            <button
              ...
              className="arrow-button"
              onMouseDown={() =>
                this.props.performMultipleTimes(() => this.props.amPmToggler())
              }
              onMouseUp={() => this.props.clearTimeoutAndInterval()}
              onMouseOut={() => this.props.clearTimeoutAndInterval()}
            >
