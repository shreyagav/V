...
class MembersUpSVG extends React.Component {
  render() {
    return (
      <svg
      ...
      >
        <path
          className="svg"
          d="M3.3,18.1c-1.1-0.2-2.1-0.7-3-1.3c-0.9-0.6,0.5-5.8,2.2-6.3c0.8,0.6,1.7,1,2.6,1c0.8,0,1.5-0.3,2.2-0.8
