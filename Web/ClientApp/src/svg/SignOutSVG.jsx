  ...
  render() {
    return (
      <div
        ...
        style={{ height: "1rem", width: "auto", marginRight: "0.5em" }}
      >
        <svg
          style={{ height: "100%" }}
          version="1.1"
        ...
        >
          <path
            className="svg"
            d="M23.8,12.5c0,0.2-0.2,0.4-0.4,0.5l-7,7c-0.5,0.5-1.6,0.5-2.2,0c-0.5-0.5-0.5-1.6,0-2.2l4.3-4.3h-2.3h-3.8h-6
