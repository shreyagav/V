...
namespace Services.Data
{
    ...
    public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContextOld>
    {
        public ApplicationDbContextOld CreateDbContext(string[] args)
        {
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContextOld>();
            ...
            optionsBuilder.UseSqlServer("Server=localhost\\sqlexpress;Initial Catalog=trr-ors;Integrated Security=true;");

            return new ApplicationDbContextOld(optionsBuilder.Options);
        }
    }

    public class ApplicationDbContextOld : IdentityDbContext<TRRUser>
    {
        public DbSet<Contact> Contacts { get; set; }
        public DbSet<UserEvent> UserEvents { get; set; }
        public DbSet<Models.Context.CalendarEvent> CalendarEvents { get; set; }
